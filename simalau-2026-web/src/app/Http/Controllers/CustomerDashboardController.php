...
class CustomerDashboardController extends Controller
{
    ...
    public function orderDetail(Request $request, Pesanan $pesanan)
    {
        ...
        return view('customer.orders.show', [
            'pesanan' => $pesanan->load(['detailPesanans.layananLaundry', 'pembayaran', 'riwayatStatuses' => fn ($query) => $query->orderBy('tanggal_perubahan')]),
        ...
        try {
            DB::transaction(function () use ($pesanan, $data, $buktiPembayaran): void {
                ...
                Pembayaran::updateOrCreate(
                    ...
                    [
                        'nomor_pembayaran' => $pembayaranLama?->nomor_pembayaran ?? Pembayaran::generateNomorPembayaran(),
