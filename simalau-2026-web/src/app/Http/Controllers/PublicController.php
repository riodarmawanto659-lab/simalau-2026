...
class PublicController extends Controller
{
    ...
    public function contact()
    {
        return view('public.contact', [
            ...
            'hariLiburMendatang' => HariLibur::query()->mendatang()->orderBy('tanggal_mulai')->take(5)->get(),
        ]);
    }
    ...
    public function checkStatus(Request $request)
    {
        ...
        $pesanan = Pesanan::with(['pelanggan', 'detailPesanans.layananLaundry', 'riwayatStatuses' => fn ($query) => $query->orderBy('tanggal_perubahan')])
