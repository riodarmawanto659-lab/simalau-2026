    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Deskripsi dan Gambar Layanan')
                    ->schema([
                        Forms\Components\FileUpload::make('gambar')
                            ->label('Gambar Layanan')
                            ->image()
                            ->disk('public')
                            ->directory('layanan-laundry')
                            ->imageEditor()
                            ->helperText('Gambar ini tampil di halaman layanan dan detail layanan pelanggan.')
                            ->columnSpanFull(),
