    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Catatan dan Gambar')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('gambar_item')
                            ->label('Gambar Item / Cucian')
                            ->image()
                            ->disk('public')
                            ->directory('detail-pesanan')
                            ->imageEditor()
                            ->helperText('Opsional. Digunakan untuk menampilkan gambar pada detail pesanan pelanggan.')
                            ->columnSpanFull(),
                    ]),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('gambar_item')
                    ->label('Gambar')
                    ->disk('public')
                    ->square()
                    ->toggleable(),
