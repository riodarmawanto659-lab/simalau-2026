...
class LayananLaundryPolicy
{
     ...
     */
    public function forceDelete(User $user, LayananLaundry $layananLaundry): bool
    {
     ...
     */
    public function restore(User $user, LayananLaundry $layananLaundry): bool
    {
     ...
     */
    public function replicate(User $user, LayananLaundry $layananLaundry): bool
    {
