...
Route::middleware('auth')->prefix('dashboard')->name('customer.')->group(function (): void {
    ...
    Route::post('/pesanan/{pesanan}/bayar', [CustomerDashboardController::class, 'payOrder'])->name('orders.pay');
    Route::get('/pembayaran/{pembayaran}/midtrans', [MidtransPaymentController::class, 'pay'])->name('payments.midtrans');
