...
class PengaturanSistemPolicy
{
     ...
     */
    public function forceDelete(User $user, PengaturanSistem $pengaturanSistem): bool
    {
     ...
     */
    public function restore(User $user, PengaturanSistem $pengaturanSistem): bool
    {
     ...
     */
    public function replicate(User $user, PengaturanSistem $pengaturanSistem): bool
    {
