...
class PengingatPengambilanPolicy
{
     ...
     */
    public function forceDelete(User $user, PengingatPengambilan $pengingatPengambilan): bool
    {
     ...
     */
    public function restore(User $user, PengingatPengambilan $pengingatPengambilan): bool
    {
     ...
     */
    public function replicate(User $user, PengingatPengambilan $pengingatPengambilan): bool
    {
