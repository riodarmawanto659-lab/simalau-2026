...
class RiwayatStatusPolicy
{
     ...
     */
    public function forceDelete(User $user, RiwayatStatus $riwayatStatus): bool
    {
     ...
     */
    public function restore(User $user, RiwayatStatus $riwayatStatus): bool
    {
     ...
     */
    public function replicate(User $user, RiwayatStatus $riwayatStatus): bool
    {
